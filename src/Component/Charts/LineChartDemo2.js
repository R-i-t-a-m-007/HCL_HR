...
const LineChartDemo2 = ({lineChartData}) => {
  return (
    ...
    >
      ...
      <XAxis dataKey="name" />
      <YAxis className="font-medium" label={{ value: 'Copper Grade', angle: -90, position: 'insideLeft', style: { textAnchor: 'middle',fill:"#000000"}}} />
      <Tooltip />
      ...
      <Line type="monotone" dataKey="Next Month" stroke="#64A33F" fill="#64A33F" />
