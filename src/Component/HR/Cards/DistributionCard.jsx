...
export const DistributionCard = ({ data, width = "17.5", showSvg }) => {
  ...
  return (
    <div
      className={`distributionCard w-[19.5rem] h-[8rem] mt-3 flex-row py-3 px-8 rounded-xl cursor-pointer bg-white text-[#002060] shadow-[4px_9px_10px_0px_rgba(0,0,0,0.13)] hover:bg-[#002060] hover:text-white`}
    >
          ...
          <Fragment key={subData.label}>
            <div className="flex-col">
              ...
              <div className="flex gap-1">
                ...
                <div className="text-xl font-semibold pt-1">{subData.val}</div>
              </div>
            </div>
            ...
            <Fragment key={subData.label}>
                <div className="flex-col">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <div className="text-xl font-semibold" title={numWords(subData.val)}>
                           {subData.val}
                        </div>
                    </div>
                </div>
